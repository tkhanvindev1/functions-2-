...
// CODE HERE
const evenNumbers = mixedNumbers.filter(function(index){
  return index % 2 === 0
})
...
/*
  Use a higher order method to get all the order totals after adding in the sales tax (given to you as a tax 
  rate, hint: you'll need to do some multiplication). 
...
// CODE HERE
// const orderTotal = orders.forEach(obj, )
...
// const bobsTotal = purchases.filter(function(obj)
// {
//   return obj.owner === 'Bob';
// }).reduce(function(acc = obj.price , curr = +obj)
// {
//   return acc + curr
// })
...
// // const arr = [
// //   {'owner': 'Bob', 'price': 1},{'owner': 'Joe', 'price': 5},
// // {'owner': 'Jane', 'price': 8},{'owner': 'Alan','price': 3},
// // {'owner': 'Samantha', 'price': 10}
// // ] 
// //  const reduceArr = arr.reduce((acc, obj) => {   return acc + obj.price }, 0)  
